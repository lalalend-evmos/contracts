...
/**
 * @title Lalalend's NEvmos Contract
 * @notice NToken which wraps EVMOS
 * @author Lalalend
 */
contract NEvmos is NToken {
    /**
     * @notice Construct a new NEvmos money market
    ...
    /**
     * @notice Send EVMOS to NEVMOS to mint
     */
    ...
    /**
     * @notice Gets balance of this contract in terms of EVMOS, before this message
     * @dev This excludes the value of the current message, if any
     * @return The quantity of EVMOS owned by this contract
     */
     ...
     * @param from Address sending the EVMOS
     * @param amount Amount of EVMOS being sent
     * @return The actual amount of EVMOS transferred
     */
    ...
    function doTransferOut(address payable to, uint amount) internal {
        /* Send the EVMOS, with minimal gas and revert on failure */
        to.transfer(amount);
    }
