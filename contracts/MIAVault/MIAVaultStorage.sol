...
contract MIAVaultAdminStorage {
    ...
    */
    ...
    /**
    * @notice Active brains of MIA Vault
    */
    address public implementation;

    /**
    * @notice Pending brains of MIA Vault
    */
    address public pendingMIAVaultImplementation;
}

contract MIAVaultStorageV1 is MIAVaultAdminStorage {
    /// @notice Guard variable for re-entrancy checks
    bool internal _notEntered;

    /// @notice The reward token store
    address public MIAStore;

    /// @notice The MIA token address
...
contract MIAVaultStorage is MIAVaultStorageV1 {
