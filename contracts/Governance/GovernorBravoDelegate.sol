...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    string public constant name = "Lalalend Governor Bravo";

    /// @notice The minimum setable proposal threshold
    // TODO 
    uint public constant MIN_PROPOSAL_THRESHOLD = 150000e18; // 150,000 MIA

    /// @notice The maximum setable proposal threshold
    uint public constant MAX_PROPOSAL_THRESHOLD = 300000e18; //300,000 MIA
    ...
    uint public constant quorumVotes = 600000e18; // 600,000 = 2% of MIA
    ...
    /**
      ...
      * @param miaVault_ The address of the MiaVault
        ...
        public
    {
        ...
        require(miaVault_ != address(0), "GovernorBravo::initialize: invalid MIA address");
        ...
        miaVault = MiaVaultInterface(miaVault_);
    ...
    function propose(address[] memory targets, uint[] memory values, string[] memory signatures, bytes[] memory calldatas, string memory description) public returns (uint) {
        ...
        require(miaVault.getPriorVotes(msg.sender, sub256(block.number, 1)) > proposalThreshold, "GovernorBravo::propose: proposer votes below proposal threshold");
    ...
    function cancel(uint proposalId) external {
        ...
        require(
            ...
            || miaVault.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold,
    ...
    function castVoteInternal(address voter, uint proposalId, uint8 support) internal returns (uint96) {
        ...
        uint96 votes = miaVault.getPriorVotes(voter, proposal.startBlock);
