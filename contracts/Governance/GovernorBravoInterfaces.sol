...
contract GovernorBravoDelegateStorageV1 is GovernorBravoDelegatorStorage {
    ...
    /// @notice The address of the Lalalend Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the MIA governance token
    MiaVaultInterface public miaVault;
