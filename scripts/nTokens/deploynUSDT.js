...
async function main() {
  ...
  const underlying = "0x56319B93cc71952c11Cf0FF6b13Ba418614eB648";
  ...
  const NUSDT = await ethers.getContractFactory("NErc20Delegator");
  const nUsdt = await NUSDT.deploy(
    underlying, 
    comptroller,
    interestRateModel,
    initialExchangeRate,
  ...
  await nUsdt.deployed();

  console.log("Deploying contracts with the account:", deployer.address);
  console.log("Deployed contract NUSDT at address:", nUsdt.address);
