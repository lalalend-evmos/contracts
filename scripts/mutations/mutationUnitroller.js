...
async function main() {
  ...
  await unitroller._setPendingImplementation("0xb0F26819Fee014272D5F2A2C1A8735bcF3e856cB");

  unitroller.on("NewPendingImplementation", (oldPendingImplementation, newPendingImplementation)=> {
