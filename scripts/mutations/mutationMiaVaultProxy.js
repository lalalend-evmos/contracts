...
async function main() {
  ...
  await miaVaultProxy._setPendingImplementation("0xB739D4615B6b3dA98b83892aD003Eece5895236F");

  miaVaultProxy.on("NewPendingImplementation", (oldPendingImplementation, newPendingImplementation)=> {
