...
async function main() {
  ...
  const miaVault = await MIAVault.attach("0xB739D4615B6b3dA98b83892aD003Eece5895236F");

  // address of vaultproxy 
  await miaVault._become("0xdf034433adB73978D328548EF21e021a8E9849DF");
